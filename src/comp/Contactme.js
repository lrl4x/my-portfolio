...
export default function Footer() {
  ...
  return (
    <section className={classes.Page}>
        ...
        >
          <TextField name="name" id="name" value={name} required label="name" variant="outlined" fullWidth type='text' onChange={(e)=>setname(e.target.test)}/>
          <TextField name="email" id="email" value={email} required label="email" variant="outlined" fullWidth type='email' onChange={(e)=>setemail(e.target.value)}/>
          <TextField name="message" id="message" value={message} required label="message" variant="outlined" fullWidth type='text' multiline maxRows={6} onChange={(e)=>setmessage(e.target.value)}/>
